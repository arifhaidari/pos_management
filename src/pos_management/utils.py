...
def get_month_data_range(months_ago=1, include_this_month=False):
    """
    A method that generates a list of dictionary
...
def unique_key_generator(instance):
    ...
    Klass = instance.__class__ # __class__ gets the models of the class of method which pass the parameter
...
def unique_access_code_generator(instance):
    """
    This is for a Django project with an access_code field
    """
